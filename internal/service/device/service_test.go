...
import (
	...
	"github.com/opencrafts-io/verisafe/internal/service/device"
)

func validInput() device.DeviceRegistrationInput {
	ip := netip.MustParseAddr("127.0.0.1")
	country := "KE"
	return device.DeviceRegistrationInput{
...
func fakeDeviceRow(
	input device.DeviceRegistrationInput,
...
func TestRegisterDevice_Success(t *testing.T) {
	...
	svc := device.NewDeviceService(mockQuerier)
